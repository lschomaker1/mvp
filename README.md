...
`mvp` is a small Linux command-line utility that behaves like `mv`, with one extra feature: when a move has to copy data, it renders a progress bar in the terminal.
